...
[text](https://ui.aceternity.com/categories/text) [content](https://ui.aceternity.com/categories/content) [hero](https://ui.aceternity.com/categories/hero) [section](https://ui.aceternity.com/categories/section) [special](https://ui.aceternity.com/categories/special)

PreviewCode

`npx shadcn@latest add @aceternity/text-generate-effect-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/text-generate-effect-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/text-generate-effect-demo.json)

Loading...

## [Link to section](https://ui.aceternity.com/components/text-generate-effect\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/text-generate-effect\#props) Props
