...
[card](https://ui.aceternity.com/categories/card) [background](https://ui.aceternity.com/categories/background) [gradient](https://ui.aceternity.com/categories/gradient) [special](https://ui.aceternity.com/categories/special) [call to action](https://ui.aceternity.com/categories/call-to-action)

PreviewCode

`npx shadcn@latest add @aceternity/background-gradient-animation-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/background-gradient-animation-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/background-gradient-animation-demo.json)

Loading...

## [Link to section](https://ui.aceternity.com/components/background-gradient-animation\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/background-gradient-animation\#props) Props
...
Special thanks to [this video](https://www.youtube.com/watch?v=Ml-B-W91gtw&t=6s) that inspired this component.
