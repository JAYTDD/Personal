...
[card](https://ui.aceternity.com/categories/card) [background](https://ui.aceternity.com/categories/background) [special](https://ui.aceternity.com/categories/special)

PreviewCode

`npx shadcn@latest add @aceternity/3d-card-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/3d-card-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/3d-card-demo.json)

Make things float in air

Hover over this card to unleash the power of CSS perspective

![thumbnail](https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=2560&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)

[Try now →](https://twitter.com/mannupaaji) Sign up

## [Link to section](https://ui.aceternity.com/components/3d-card-effect\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/3d-card-effect\#examples) Examples

With rotation

PreviewCode

`npx shadcn@latest add @aceternity/3d-card-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/3d-card-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/3d-card-demo-2.json)
...
## [Link to section](https://ui.aceternity.com/components/3d-card-effect\#props) Props
