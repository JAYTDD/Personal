...
[bento grid](https://ui.aceternity.com/categories/bento-grid) [card](https://ui.aceternity.com/categories/card) [border](https://ui.aceternity.com/categories/border) [highlight](https://ui.aceternity.com/categories/highlight)

PreviewCode

`npx shadcn@latest add @aceternity/glowing-effect-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/glowing-effect-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/glowing-effect-demo.json)
...
## [Link to section](https://ui.aceternity.com/components/glowing-effect\#installation) Installation
...
#### [Link to section](https://ui.aceternity.com/components/glowing-effect\#example) Example

Here is another example usage of the same component with different props.

PreviewCode

`npx shadcn@latest add @aceternity/glowing-effect-demo-2`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/glowing-effect-demo-2) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/glowing-effect-demo-2.json)
...
## [Link to section](https://ui.aceternity.com/components/glowing-effect\#props) Props
...
This component was inspired by [Cursor's Enterprise page](https://cursor.sh/enterprise).
