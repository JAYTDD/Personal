...
[card](https://ui.aceternity.com/categories/card) [special](https://ui.aceternity.com/categories/special)

PreviewCode

`npx shadcn@latest add @aceternity/card-hover-effect-demo`Copy

Copy prompt [Open in full screen](https://ui.aceternity.com/live-preview/card-hover-effect-demo) [Open in v0](https://v0.dev/chat/api/open?url=https://ui.aceternity.com/registry/card-hover-effect-demo.json)

[**Stripe** \\
\\
A technology company that builds economic infrastructure for the internet.](https://stripe.com/) [**Netflix** \\
\\
A streaming service that offers a wide variety of award-winning TV shows, movies, anime, documentaries, and more on thousands of internet-connected devices.](https://netflix.com/) [**Google** \\
\\
A multinational technology company that specializes in Internet-related services and products.](https://google.com/) [**Meta** \\
\\
A technology company that focuses on building products that advance Facebook's mission of bringing the world closer together.](https://meta.com/) [**Amazon** \\
\\
A multinational technology company focusing on e-commerce, cloud computing, digital streaming, and artificial intelligence.](https://amazon.com/) [**Microsoft** \\
\\
A multinational technology company that develops, manufactures, licenses, supports, and sells computer software, consumer electronics, personal computers, and related services.](https://microsoft.com/)

## [Link to section](https://ui.aceternity.com/components/card-hover-effect\#installation) Installation
...
## [Link to section](https://ui.aceternity.com/components/card-hover-effect\#props) Props
